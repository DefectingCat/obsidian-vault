...
```
File {name: "1000.webp", lastModified: 1670932088423, lastModifiedDate: Tue Dec 13 2022 19:48:08 GMT+0800 (香港标准时间), webkitRelativePath: "", size: 21304…}
name: "1000.webp"
...
不过这仅仅只是第一步，input 标签只会检查文件的拓展名，并不会真正的检查文件的类型。如果将一个文件修改为特定的拓展名，则可以通过 input 标签轻松选择。
