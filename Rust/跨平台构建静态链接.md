...
volumes:
  gitlab-runner-1:
    driver_opts:
      type: none
      device: /home/xfy/docker/dockge/stacks/gitlab-runner/runner-1
      o: bind
  gitlab-runner-2:
    driver_opts:
      type: none
      device: /home/xfy/docker/dockge/stacks/gitlab-runner/runner-2
      o: bind
networks: {}
```
...
在某些情况下，我们可能需要在 CI 中使用 docker 来构建某些东西，这就需要在 CI 中使用 docker
